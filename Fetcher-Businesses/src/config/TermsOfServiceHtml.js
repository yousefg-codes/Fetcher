...
const TermsOfServiceHtml = (props) => {
  return (
    <div
      style={props.style ? props.style : {}}
      className="policySecondaryContainer tabPageBlob"
    >
      <strong>TERMS OF USE</strong>
      <br /> Last updated December 29, 2020
      <br />
      <br />
      <br /> <strong>AGREEMENT TO TERMS</strong>
      <br /> These Terms of Use constitute a legally binding agreement made
      between you, whether personally or on behalf of an entity (“you”) and
      Fetcher Technologies ("Company", “we”, “us”, or “our”), concerning your
      access to and use of the https://www.fetchertech.com website as well as
      ...
      “Site”). You agree that by accessing the Site, you have read, understood,
      ...
      <br /> The Site is not tailored to comply with industry-specific
      ...
      Site.
      <br /> <strong>INTELLECTUAL PROPERTY RIGHTS</strong>
      <br /> Unless otherwise indicated, the Site is our proprietary property
      ...
      <br /> Provided that you are eligible to use the Site, you are granted a
      ...
      <br /> <strong>USER REPRESENTATIONS</strong>
      <br /> By using the Site, you represent and warrant that: (1) all
      ...
      the legal capacity and you agree to comply with these Terms of Use; (4)
      you are not a minor in the jurisdiction in which you reside; (5) you will
      not access the Site through automated or non-human means, whether through
      a bot, script, or otherwise; (6) you will not use the Site for any illegal
      ...
      <br /> You may be required to register with the Site. You agree to keep
      ...
      <br /> <strong>PROHIBITED ACTIVITIES</strong>
      <br /> You may not access or use the Site for any purpose other than that
      for which we make the Site available. The Site may not be used in
      connection with any commercial endeavors except those that are
      specifically endorsed or approved by us.
      <br /> As a user of the Site, you agree not to:
      <br /> 1. Systematically retrieve data or other content from the Site to
      create or compile, directly or indirectly, a collection, compilation,
      database, or directory without written permission from us.
      <br /> 2. Trick, defraud, or mislead us and other users, especially in any
      attempt to learn sensitive account information such as user passwords.
      <br /> 3. Circumvent, disable, or otherwise interfere with
      ...
      <br /> 4. Disparage, tarnish, or otherwise harm, in our opinion, us and/or
      the Site.
      <br /> 5. Use any information obtained from the Site in order to harass,
      abuse, or harm another person.
      <br /> 6. Make improper use of our support services or submit false
      reports of abuse or misconduct.
      <br /> 7. Use the Site in a manner inconsistent with any applicable laws
      or regulations.
      <br /> 8. Engage in unauthorized framing of or linking to the Site.
      <br /> 9. Upload or transmit (or attempt to upload or to transmit)
      ...
      <br /> 10. Engage in any automated use of the system, such as using
      scripts to send comments or messages, or using any data mining, robots, or
      similar data gathering and extraction tools.
      <br /> 11. Delete the copyright or other proprietary rights notice from
      any Content.
      <br /> 12. Attempt to impersonate another user or person or use the
      username of another user.
      <br /> 13. Upload or transmit (or attempt to upload or to transmit) any
      ...
      mechanisms” or “pcms”).
      <br /> 14. Interfere with, disrupt, or create an undue burden on the Site
      or the networks or services connected to the Site.
      <br /> 15. Harass, annoy, intimidate, or threaten any of our employees or
      agents engaged in providing any portion of the Site to you.
      <br /> 16. Attempt to bypass any measures of the Site designed to prevent
      or restrict access to the Site, or any portion of the Site.
      <br /> 17. Copy or adapt the Site’s software, including but not limited to
      Flash, PHP, HTML, JavaScript, or other code.
      <br /> 18. Decipher, decompile, disassemble, or reverse engineer any of
      the software comprising or in any way making up a part of the Site.
      <br /> 19. Except as may be the result of standard search engine or
      ...
      <br /> 20. Use a buying agent or purchasing agent to make purchases on the
      Site.
      <br /> 21. Make any unauthorized use of the Site, including collecting
      ...
      <br /> 22. Use the Site as part of any effort to compete with us or
      otherwise use the Site and/or the Content for any revenue-generating
      endeavor or commercial enterprise.
      <br /> 23. Add any Products that contain any of the following: alcohol,
      legal and illegal drugs/medications, shisha and hookah, tobacco,
      marijuana, nicotine
      <br /> <strong>USER GENERATED CONTRIBUTIONS</strong>
      <br /> The Site may invite you to chat, contribute to, or participate in
      blogs, message boards, online forums, and other functionality, and may
      provide you with the opportunity to create, submit, post, display,
      transmit, perform, publish, distribute, or broadcast content and materials
      to us or on the Site, including but not limited to text, writings, video,
      ...
      <br /> 2. You are the creator and owner of or have the necessary licenses,
      ...
      <br /> 3. You have the written consent, release, and/or permission of each
      ...
      <br /> 5. Your Contributions are not unsolicited or unauthorized
      advertising, promotional materials, pyramid schemes, chain letters, spam,
      mass mailings, or other forms of solicitation.
      <br /> 6. Your Contributions are not obscene, lewd, lascivious, filthy,
      violent, harassing, libelous, slanderous, or otherwise objectionable (as
      determined by us).
      <br /> 7. Your Contributions do not ridicule, mock, disparage, intimidate,
      or abuse anyone.
      ...
      <br /> 9. Your Contributions do not violate any applicable law,
      regulation, or rule.
      <br /> 10. Your Contributions do not violate the privacy or publicity
      rights of any third party.
      <br /> 11. Your Contributions do not contain any material that solicits
      personal information from anyone under the age of 18 or exploits people
      under the age of 18 in a sexual or violent manner.
      <br /> 12. Your Contributions do not violate any applicable law concerning
      child pornography, or otherwise intended to protect the health or
      well-being of minors.
      <br /> 13. Your Contributions do not include any offensive comments that
      are connected to race, national origin, gender, sexual preference, or
      physical handicap.
      <br /> 14. Your Contributions do not otherwise violate, or link to
      ...
      <br /> <strong>CONTRIBUTION LICENSE</strong>
      ...
      <br /> This license will apply to any form, media, or technology now known
      ...
      <br /> We do not assert any ownership over your Contributions. You retain
      ...
      edit, redact, or otherwise change any Contributions; (2) to re-categorize
      any Contributions to place them in more appropriate locations on the Site;
      ...
      Contributions.
      <br /> <strong>SUBMISSIONS</strong>
      <br /> You acknowledge and agree that any questions, comments,
      ...
      <br /> <strong>THIRD-PARTY WEBSITE AND CONTENT</strong>
      <br /> The Site may contain (or you may be sent via the Site) links to
      ...
      <br /> <strong>SITE MANAGEMENT</strong>
      <br /> We reserve the right, but not the obligation, to: (1) monitor the
      ...
      these Terms of Use, including without limitation, reporting such user to
      ...
      <br /> We care about data privacy and security. Please review our Privacy
      Policy: https://www.fetchertech.com/privacypolicy. By using the Site, you
      ...
      States, and you agree to have your data transferred to and processed in
      the United States.
      <br /> <strong>COPYRIGHT INFRINGEMENTS</strong>
      <br /> We respect the intellectual property rights of others. If you
      believe that any material available on or through the Site infringes upon
      ...
      use the Site. WITHOUT LIMITING ANY OTHER PROVISION OF THESE TERMS OF USE,
      ...
      injunctive redress.
      <br /> <strong>MODIFICATIONS AND INTERRUPTIONS</strong>
      <br /> We reserve the right to change, modify, or remove the contents of
      ...
      <br /> We cannot guarantee the Site will be available at all times. We may
      ...
      <br /> <strong>DISPUTE RESOLUTION</strong>
      <br /> Informal Negotiations
      ...
      <br /> If the Parties are unable to resolve a Dispute through informal
      negotiations, the Dispute (except those Disputes expressly excluded below)
      will be finally and exclusively resolved through binding arbitration. YOU
      ...
      King County, Washington. Except as otherwise provided herein, the Parties
      ...
      <br /> If for any reason, a Dispute proceeds in court rather than
      arbitration, the Dispute shall be commenced or prosecuted in the state and
      federal courts located in King County, Washington, and the Parties hereby
      ...
      <br /> In no event shall any Dispute brought by either Party related in
      any way to the Site be commenced more than one (1) years after the cause
      ...
      <br /> Restrictions
      <br /> The Parties agree that any arbitration shall be limited to the
      Dispute between the Parties individually. To the full extent permitted by
      ...
      class-action basis or to utilize class action procedures; and (c) there is
      ...
      persons.
      <br /> Exceptions to Informal Negotiations and Arbitration
      <br /> The Parties agree that the following Disputes are not subject to
      ...
      the validity of, any of the intellectual property rights of a Party; (b)
      ...
      <br /> <strong>CORRECTIONS</strong>
      <br /> There may be information on the Site that contains typographical
      ...
      <br /> <strong>LIMITATIONS OF LIABILITY</strong>
      <br />{" "}
      <strong>
        ...
        PAID, IF ANY, BY YOU TO US OR $500.00 USD. CERTAIN US STATE LAWS AND
      ...
      <br /> <strong>INDEMNIFICATION</strong>
      <br /> You agree to defend, indemnify, and hold us harmless, including our
      ...
      <br /> <strong>USER DATA</strong>
      <br /> We will maintain certain data that you transmit to the Site for the
      ...
      <br /> Visiting the Site, sending us emails, and completing online forms
      ...
      electronic means.
      <br /> <strong>CALIFORNIA USERS AND RESIDENTS</strong>
      <br /> If any complaint with us is not satisfactorily resolved, you can
      ...
      <br /> These Terms of Use and any policies or operating rules posted by us
      on the Site or in respect to the Site constitute the entire agreement and
      ...
      <br /> In order to resolve a complaint regarding the Site or to receive
      further information regarding use of the Site, please contact us at:
      <br />
      <br /> United States
      <br /> Phone: 4255053706
      <br /> support@fetchertech.com
    </div>
  );
};
export default TermsOfServiceHtml;
