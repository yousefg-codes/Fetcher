export default {
  privacyPolicy:
    'Last updated August 08, 2020   \
                                                  \
    Thank you for choosing to be part of our community at Fetcher Technologies (“Company”, “we”, “us”, or “our”). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at support@fetchertech.com.  \
      \
    ...
    The personal information that we collect depends on the context of your interactions with us and the App, the choices you make and the products and features you use. The personal information we collect may include the following:  \
      \
    Personal Information Provided by You. We collect names; email addresses; mailing addresses; passwords; billing addresses; debit/credit card numbers; and other similar information.  \
      \
    ...
    If you are resident in Switzerland, the contact details for the data protection authorities are available here: https://www.edoeb.admin.ch/edoeb/en/home.html.  \
      \
      \
    If you have questions or comments about your privacy rights, you may email us at support@fetchertech.com.  \
      \
      \
    Account Information  \
    ...
    More information about our data collection and sharing practices can be found in this privacy notice.  \
      \
    You may contact us by email at support@fetchertech.com, or by referring to the contact details at the bottom of this document.  \
      \
    ...
    Fetcher Technologies has disclosed the following categories or personal information to third parties for a business or commercial purpose in the preceding twelve (12) months:  \
      \
      \
    ...
    you may request to opt-out from future selling of your personal information to third parties. Upon receiving a request to opt-out, we will act upon the request as soon as feasibly possible, but no later than 15 days from the date of the request submission.  \
      \
    To exercise these rights, you can contact us by email at support@fetchertech.com, or by referring to the contact details at the bottom of this document. If you have a complaint about how we handle your data, we would like to hear from you.  \
      \
      \
    13. DO WE MAKE UPDATES TO THIS NOTICE?  \
      \
    ...
    14. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?  \
      \
    If you have questions or comments about this notice, you may email us at support@fetchertech.com  \
      \
      \
    HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?  \
      \
    Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please submit a request by emailing us at support@fetchertech.com with your full name, and email, and what you would like to edit, review, or update. We will respond to your request within 30 days.',
  termsAndConditions:
    "Last updated August 08, 2020 \
 \
 \
 \
    Fetcher is licensed to You (End-User) by Fetcher Technologies (hereinafter: Licensor), for use only under the terms of this License Agreement. \
     \
    By downloading the Application from the Apple AppStore, and any update thereto (as permitted by this License Agreement), You indicate that You agree to be bound by all of the terms and conditions of this License Agreement, and that You accept this License Agreement. \
     \
    The parties of this License Agreement acknowledge that Apple is not a Party to this License Agreement and is not bound by any provisions or obligations with regard to the Application, such as warranty, liability, maintenance and support thereof. Fetcher Technologies, not Apple, is solely responsible for the licensed Application and the content thereof. \
     \
    This License Agreement may not provide for usage rules for the Application that are in conflict with the latest App Store Terms of Service. Fetcher Technologies acknowledges that it had the opportunity to review said terms and this License Agreement is not conflicting with them. \
     \
    ...
    1. THE APPLICATION \
     \
    Fetcher (hereinafter: Application) is a piece of software created to allow users to make purchases from nearby small businesses and have their purchases delivered to their door. - and customized for Apple mobile devices. It is used to make online orders that are delivered to the user's door. \
     \
    ...
    2. SCOPE OF LICENSE \
     \
    2.1  You may not share or make the Application available to third parties (unless to the degree allowed by the Apple Terms and Conditions, and with Fetcher Technologies's prior written consent), sell, rent, lend, lease or otherwise redistribute the Application. \
     \
    2.2  You may not reverse engineer, translate, disassemble, integrate, decompile, integrate, remove, modify, combine, create derivative works or updates of, adapt, or attempt to derive the source code of the Application, or any part thereof (except with Fetcher Technologies's prior written consent). \
     \
    ...
    4.1  The Licensor is solely responsible for providing any maintenance and support services for this licensed Application. You can reach the Licensor at the email address listed in the App Store Overview for this licensed Application. \
     \
    4.2  Fetcher Technologies and the End-User acknowledge that Apple has no obligation whatsoever to furnish any maintenance and support services with respect to the licensed Application. \
     \
     \
    5. USE OF DATA \
     \
    You acknowledge that Licensor will be able to access and adjust Your downloaded licensed Application content and Your personal information, and that Licensor's use of such material and information is subject to Your legal agreements with Licensor and Licensor's privacy policy, located below terms and conditions in the account screen. \
     \
     \
    6. LIABILITY \
     \
    ...
    7.1  Licensor warrants that the Application is free of spyware, trojan horses, viruses, or any other malware at the time of Your download. Licensor warrants that the Application works as described in the user documentation. \
     \
    7.2  No warranty is provided for the Application that is not executable on the device, that has been unauthorizedly modified, handled inappropriately or culpably, combined or installed with inappropriate hardware or software, used with inappropriate accessories, regardless if by Yourself or by third parties, or if there are any other reasons outside of Fetcher Technologies's sphere of influence that affect the executability of the Application. \
     \
    7.3  You are required to inspect the Application immediately after installing it and notify Fetcher Technologies about issues discovered without delay by e-mail provided in Product Claims. The defect report will be taken into consideration and further investigated if it has been mailed within a period of sixty (60) days after discovery. \
     \
    7.4  If we confirm that the Application is defective, Fetcher Technologies reserves a choice to remedy the situation either by means of solving the defect or substitute delivery. \
     \
    ...
    8. PRODUCT CLAIMS \
     \
    Fetcher Technologies and the End-User acknowledge that Fetcher Technologies, and not Apple, is responsible for addressing any claims of the End-User or any third party relating to the licensed Application or the End-User’s possession and/or use of that licensed Application, including, but not limited to: \
     \
    ...
    11. TERMINATION \
     \
    The license is valid until terminated by Fetcher Technologies or by You. Your rights under this license will terminate automatically and without notice from Fetcher Technologies if You fail to adhere to any term(s) of this license. Upon License termination, You shall stop all use of the Application, and destroy all copies, full or partial, of the Application. \
     \
     \
    12. THIRD-PARTY TERMS OF AGREEMENTS AND BENEFICIARY \
     \
    Fetcher Technologies represents and warrants that Fetcher Technologies will comply with applicable third-party terms of agreement when using licensed Application. \
     \
    ...
    13. INTELLECTUAL PROPERTY RIGHTS \
     \
    Fetcher Technologies and the End-User acknowledge that, in the event of any third-party claim that the licensed Application or the End-User's possession and use of that licensed Application infringes on the third party's intellectual property rights, Fetcher Technologies, and not Apple, will be solely responsible for the investigation, defense, settlement and discharge or any such intellectual property infringement claims. \
     \
     \
    14. APPLICABLE LAW \
     \
  ...
  helpText:
    "NOTE: If any of your questions cannot be answered in the Help section please send us an email at: support@fetchertech.com \
   \n UI questions: \n 1. Q: Where can I find all the products available from a specific business? A: To find all the products available by a specific business, click on the business's marker (the businesss location with a logo) on the map in the Home screen.\
   \n 2. Q: How can I change my Main Address? A: to change your Main Address, first navigate to the Account Screen and click on Addresses, then click Edit at the top Right of the screen, and click on an address other than your current Main Address to make it the new Main Address. \
   ",
  aboutText:
    'Fetcher Technologies is fouded by a group of young entrepreneurs and developers, who are seeking to innovate the ways people interact with technology in their daily lives, and to invent new purposes for users to get immersed into the digital world.',
};
