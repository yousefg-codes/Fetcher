export default (strings = {
  privacyPolicy:
    ...
    The personal information that we collect depends on the context of your interactions with us and the App, the choices you make and the products and features you use. The personal information we collect may include the following:  \
      \
    Personal Information Provided by You. We collect names; phone numbers; email addresses; mailing addresses; passwords; billing addresses; contact or authentication data; account/routing numbers; government-related identification; and other similar information.  \
      \
    ...
    Cloud Storage for Firebase, Cloud Functions for Firebase , Cloud Firestore and Firebase Realtime Database  \
    ...
    NO  \
      \
    F. Internet or other similar network activity	Browsing history, search history, online behavior, interest data, and interactions with our and other apps, applications, systems and advertisements  \
      \
    NO  \
      \
 ...
 \
    Last updated August 29, 2020 \
     ...
     \
     \
    Fetcher Drivers is licensed to You (End-User) by Fetcher Technologies, (hereinafter: Licensor), for use only under the terms of this License Agreement. \
     \
    ...
    1. THE APPLICATION \
     \
    Fetcher Drivers (hereinafter: Application) is a piece of software created to Allow the app's users to deliver items for customers. - and customized for Apple mobile devices. It is used to Make money by delivering items.. \
     \
    ...
    2.3  You may not copy (excluding when expressly authorized by this license and the Usage Rules) or alter the Application or portions thereof. You may create and store copies only on devices that You own or control for backup keeping under the terms of this license, the App Store Terms of Service, and any other terms and conditions that apply to the device or software used. You may not remove any intellectual property notices. You acknowledge that no unauthorized third parties may gain access to these copies at any time. \
     \
    2.4  You may not end an order (which is done by clicking the finish order button) before you have delivered the cutomer's items to their door\
    \
    ...
    4. NO MAINTENANCE OR SUPPORT \
     \
    4.1  Fetcher Technologies is not obligated, expressed or implied, to provide any maintenance, technical or other support for the Application. \
     \
    ...
    5. USE OF DATA \
     \
    You acknowledge that Licensor will be able to access and adjust Your downloaded licensed Application content and Your personal information, and that Licensor's use of such material and information is subject to Your legal agreements with Licensor and Licensor's privacy policy, found at the bottom of the side-menu, once you sign in. \
     \
     \
    6. LIABILITY \
     \
  ...
  backgroundCheckPolicy:
    'We ("Fether Technologies") conduct an Identity Background Check on all of our drivers, before we allow them to deliver under our name. Once a driver has completed signing up, they will be placed on a queue where their background check will be processed ASAP. We do not use background checks to determine whether we should allow you to become a driver, unless we discover you have given us a false identity. We only use them to verify your identity, and gain a demographic understanding of our drivers.',
});
